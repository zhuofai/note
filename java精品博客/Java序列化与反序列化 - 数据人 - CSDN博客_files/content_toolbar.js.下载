            ...
            <li class="toolbar-tracking csdn-tracking-statistics tracking-click" data-mod="popu_369"><a href="#" style="padding:0"></a></li>\
              ...
              <li class="userLogin">\
                ...
                <div class="userControl">\
                  ...
                  <div><a href="https://mp.csdn.net/postlist" target="_blank">创作中心</a></div>\
...
$(function(){
  ...
  function detectZoom (){ 
    var ratio = 0,
      ...
      userAgent = /Safari/.test(navigator.userAgent) && !/Chrome/.test(navigator.userAgent);
  ...
  function resized() {
      var container = $(".csdn-toolbar .container")
      if(detectZoom() < 90 || (window.devicePixelRatio == 1.5 && detectZoom() == 100)){
        $(container).addClass("xs-container")
      }else{
        $(container).removeClass("xs-container")
      }
    }
